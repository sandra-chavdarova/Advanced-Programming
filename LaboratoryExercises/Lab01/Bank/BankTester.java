...
public class BankTester {
    ...
    private static void testEquals() {
        ...
        FlatAmountProvisionTransaction fa1 = new FlatAmountProvisionTransaction(10, 20, 20.0, 10);
        FlatAmountProvisionTransaction fa2 = new FlatAmountProvisionTransaction(20, 20, 20.0, 10);
        FlatAmountProvisionTransaction fa3 = new FlatAmountProvisionTransaction(20, 10, 20.0, 10);
        FlatAmountProvisionTransaction fa4 = new FlatAmountProvisionTransaction(10, 20, 50.0, 50);
        FlatAmountProvisionTransaction fa5 = new FlatAmountProvisionTransaction(30, 40, 20.0, 10);
        ...
        List<Account> accounts = new ArrayList<>(Arrays.asList(a1, a2, a3, a4));
        List<Account> accounts1 = new ArrayList<>(Arrays.asList(a2, a1, a3, a4));
        List<Account> accounts2 = new ArrayList<>(Arrays.asList(a1, a2, a3));
        List<Account> accounts3 = new ArrayList<>(Arrays.asList(a1, a2, a3, a4));
        ...
        long to_id = a3.getId();
        Transaction t = new FlatAmountProvisionTransaction(from_id, to_id, 3.0, 3);
    ...
    private static void testTypicalUsage(Scanner jin) {
        ...
        jin.nextLine();
        List<Account> accounts = new ArrayList<>(num_accounts);
        for (int i = 0; i < num_accounts; ++i)
            accounts.add(new Account(jin.nextLine(), parseAmount(jin.nextLine())));
